...
},{"datatables.net":1,"jquery":2}],4:[function(require,module,exports){
var DataTablePlus = require("./DataTablePlus.js") //make exports using  nodejs
...
$(document).ready(function() {
    ...
    var table_row_content_template = [
        '<input type="text" name="word-correct" placeholder="Text" style="width:90%">',
        '<input type="text" name="word-incorrect" placeholder="Text" style="width:90%">'
        ]

    var dataTablePlus = new DataTablePlus({selector_id:"#inputFormTable",delete_add_row:true,
        buttons_options_elements: {deleteButton:$("#deleteRowButton"), addButton:$("#addRowButton")},
        datatable_args:{"paging":   false,"searching": false },
        row_content_template:table_row_content_template,
        nr_rows:1
    })
